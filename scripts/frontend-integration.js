 ...
 * This file demonstrates how to integrate Querycore with a web frontend
 */

// For React/Vue/Angular applications
export class QuerycoreClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new QuerycoreClient(provider, contractAddress);
